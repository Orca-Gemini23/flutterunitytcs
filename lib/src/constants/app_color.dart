...
class AppColor {
  ...
  static const Color bgColor = Color(0XFFFBFCEB);
  static const Color greyLight = Color.fromARGB(255, 211, 211, 211);
  static const Color drawerColor = Color(0XFF354e2c);
  static const Color appBarColor = Color(0XFFb2de27);
  static const Color appShadowDark = Color.fromARGB(255, 182, 182, 182);
  ...
  static const Color batteryindicatorgreen = Color(0XFF0C6658);
  ...
  static Color batteryindicatorshadowred =
      const Color(0XFFDEBAA5).withOpacity(.4);
}

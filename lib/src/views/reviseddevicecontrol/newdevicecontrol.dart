...
class _DeviceControlPageState extends State<DeviceControlPage>
  ...
  void initState() {
    ...
    FlutterBackgroundService().invoke("scanBleConnect");
    WidgetsBinding.instance.addObserver(this);

    WidgetsFlutterBinding.ensureInitialized();
    if (!deviceController.batteryInfoStatus) {
      ////If we dont have the values then only get them else not
      ...
      WidgetsBinding.instance.addPostFrameCallback(
        (timeStamp) async {
          AwesomeDialog(
                  ...
                  desc:
                      "Please wait while we are fetching data from the device")
              .show();
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) async {
    ...
    switch (state) {
      ...
      case AppLifecycleState.paused:
        ...
        log("running foreground service when app is paused");
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () async {
                              ...
                              bool isleftBatteryRefreshed =
                                  await deviceController.refreshBatteryValues();
                            },
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Visibility(
                                    replacement: CircularPercentIndicator(
                                      radius: 20.w,
                                    ...
                                    child: CircularPercentIndicator(
                                      ...
                                      radius: 20.w,
                                      center: deviceController.battS < 30
                                          ? const Icon(
                                              Icons.error,
                                              color: Colors.red,
                                            )
                                          : null,
                                      progressColor: deviceController.battS < 30
                                          ? Colors.red
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  CircularPercentIndicator(
                                    ...
                                    radius: 20.w,
                                    center: deviceController.battC < 30
                                        ? const Icon(
                                            Icons.error,
                                            color: Colors.red,
                                          )
                                        : null,
                                    progressColor: deviceController.battC < 30
                                        ? Colors.red
                                        : AppColor.greenDarkColor,
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: SliderTheme(
                              ...
                              child: Slider(
                                value: deviceController.frequencyValue,
                                min: 0.3,
                                max: 2,
                                label:
                                ...
                                onChanged: (value) {
                                  ...
                                  deviceController.setfreqValue(value);
                                },

...
class FishTherapySessionBtn extends StatefulWidget {
  ...
  @override
  State<FishTherapySessionBtn> createState() => _FishTherapySessionBtnState();
}

class _FishTherapySessionBtnState extends State<FishTherapySessionBtn> {
  ...
  void therapyButtonOnPressed(DeviceController deviceController) async {
    if (deviceController.connectedDevice == null) {
      ...
      Navigator.push(context,
          MaterialPageRoute(builder: ((context) => const UnityScreen(i: 1))));
    }
  }
}
